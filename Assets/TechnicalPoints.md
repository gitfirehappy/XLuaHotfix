...
└─────────────────────────┬───────────────────────────────────┘
         ...
         ▼                ▼                ▼
┌─────────────────┐ ┌─────────────┐ ┌──────────────────┐
│   核心层 Core   │ │ 框架层 FW   │ │   资源层 Resource │
│─────────────────│ │─────────────│ │──────────────────│
│ • AAPackageMgr  │ │ • EventCtr  │ │ • BuildIndexData │
│ • PathManager   │ │ • UIMgr     │ │ • VersionState   │
│ • XLuaLoader    │ │ • Dialogue  │ │ • LabelsConfig   │
│ • LogUtility    │ │ • ConfigConv│ │ • LuaScriptsIndex│
│ • CoroutineBrg  │ │ • Bridge    │ │ • Manifest       │
└─────────────────┘ └─────────────┘ └──────────────────┘
```
