...
/// </summary>
/// <remarks>
/// Package 承载后端的 BuildPackageRequest（含输出目录、attempt 布局与交付出口），
...
{
    /// <summary>后端包请求（Editor 侧为 BuildPackageRequest）</summary>
    public readonly BuildPackageRequest Package;
    ...
    public BuildRequest(BuildPackageRequest package, BuildExecutionOptions options = null, IBuildRunEnvironment environment = null)
    {
