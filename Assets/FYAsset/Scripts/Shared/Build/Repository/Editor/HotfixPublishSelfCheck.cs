...
public static class HotfixPublishSelfCheck
{
    ...
    public static void Run()
    {
        ...
        try
        {
            ...
            RepositoryCommit aaCommit = CreatePackage(sourceRoot, "Build_AA_4.0.0", BackendModeNames.AA, "aa-v1");
            RepositoryCommit abCommit = CreatePackage(sourceRoot, "Build_AB_1.0.0", BackendModeNames.AB, "ab-v1");
    ...
    private static void VerifyRollback(string root, string serviceRoot)
    {
        ...
        RepositoryCommit newCommit = CreatePackage(Path.Combine(root, "rollback-source"), "Build_AA_4.0.1", BackendModeNames.AA, "aa-v2");
    ...
    private static RepositoryCommit CreatePackage(string sourceRoot, string packageName, string backendMode, string marker)
    {
    ...
    private static PushPayload CreatePayload(RepositoryCommit commit)
    {
        return new PushPayload { ToCommit = commit };
    }
