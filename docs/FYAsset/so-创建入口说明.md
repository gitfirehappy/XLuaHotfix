...
> `Assets/FYAsset/Scripts/Build/Editor/ABPipeline/AssetCollectionSettingPanel.cs`
...
| `AssetCollectionSetting` | `AssetCollectionSettingPanel` 中的创建按钮 | 资产收集配置资产，走 AB Pipeline 面板入口 |
