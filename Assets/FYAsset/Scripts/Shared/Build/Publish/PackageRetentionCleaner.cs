...
/// </remarks>
public static class PackageRetentionCleaner
{
    private const string LogPrefix = "[PackageRetentionCleaner]";
    ...
    public static CleanupResult CleanupUnreferencedPackages(string serverBackendRoot, string packagesFolderName)
    {
