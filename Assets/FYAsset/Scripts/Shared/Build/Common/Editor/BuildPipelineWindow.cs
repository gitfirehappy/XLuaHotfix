...
public abstract class BuildPipelineWindowBase : EditorWindow
{
    ...
    private void BuildRoot()
    {
        ...
        _sidebar = new ScrollView(ScrollViewMode.Vertical) { name = "Sidebar" };
        ...
        contentShell.style.paddingLeft = 8f;
        contentShell.style.paddingRight = 8f;
        contentShell.style.paddingTop = 8f;
        contentShell.style.paddingBottom = 8f;
        contentShell.style.minHeight = 0f;
    ...
    private void SelectPanel(int panelIndex, bool force)
    {
        ...
        for (int i = 0; i < _panelButtons.Length; i++)
        {
            ...
            _panelButtons[i].style.color = active ? Color.white : BuildPipelineUI.SecondaryTextColor;
