...
Verified implementation mistakes and confirmed troubleshooting outcomes. Each entry keeps the original IP number and
uses the standard Symptom, Root cause, Fix, and Prevention fields.
