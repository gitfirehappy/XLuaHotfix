...
public sealed class CloudflarePagesPushTarget : IPushTarget
{
    ...
    public PushReceipt Push(PushPayload payload)
    {
        ...
        string backendRoot = PushTargetUtility.ResolveBackendRoot(_config, payload.ToCommit.BackendMode);
        ...
        try
        {
            ...
            return new PushReceipt
            {
                ...
                TargetLocation = PushTargetUtility.GetBackendHotfixUrl(
                    _config,
                    string.Equals(payload.ToCommit.BackendMode, BackendModeNames.AB, StringComparison.OrdinalIgnoreCase)
