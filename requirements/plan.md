...
| File | Content | Status |
|------|---------|--------|
| plan-build-state-cleanup-tools-20260707.md | Version test reset/read-only metadata, package output listing/deletion, and channel-scoped repository test reset with explicit destructive options | Implemented / Verified / Pending developer sign-off |
...
| plan-aa-ab-shared-split-20260709.md | A1/A3/A5+A9: AA/AB/Shared root split, concrete runtime/hotfix/build managers, thin compatibility facades, settings LoadOrCreate dedup | Implemented / Verified / Pending developer sign-off |
